...
function Navbar() {
    ...
    const [mdCheck, setMd] = useState(false)
    ...
    useEffect(() => {
        width < 940 ? setMd(true) : setMd(false)
    }, [width])
    useEffect(() => {
        ...
        if (mdCheck) {
            ...
            return (
                <nav className='flex items-center'>
                    <a href="#" className='mr-12 text-md text-gray hover:text-white'>
                        How it works
                    </a>
                    <a href="#" className='mr-12 text-md text-gray hover:text-white'>
                        Prices
                    </a>
                    <button className='transition duration-300 mr-4 rounded-md border-darker  text-white text-[.9em] bg-gradient-to-r from-rr to-t hover:from-rr hover:to-tt  w-32 py-1 items-center justify-center flex'>
                        Sign up
                    </button>
                    <button className='transition duration-300 rounded-md border-white hover:bg-white hover:text-bg border text-white text-[.9em] bg-transparent w-32 py-1 items-center justify-center flex'>
                        Download
                    </button>
                </nav>
            )
    ...
    const renderRespMenu = () => {
        if (menuStat && mdCheck) {
            return (
                <div className='w-full sfixed z-10 top-0 h-screen bg-lbg fixed top-0 translate-x-0 animate-[wiggle_.5s_ease-in-out]'>
                    <nav className='flex items-center flex-col justify-center h-full'>
                        ...
                        <button className='rounded-md text-white text-lg bg-gradient-to-r from-rr to-t w-6/12 items-center justify-center flex mt-12 h-12'>
                            Sign up
                        </button>
                        <button className='transition duration-300 rounded-md border-white hover:bg-white hover:text-bg border text-white text-lg bg-transparent w-32 py-2 w-6/12 mt-4 items-center justify-center flex'>
                            Download
                        </button>
                    </nav>
                </div>
